...
public class userService {
    ...
    public user addUser(user u) { return repository.save(u); }
...
//    }
    ...
    public ArrayList<user> getAll(Long id)
    {
        return (ArrayList<user>) repository.findAllById(Collections.singleton(id));
    }
